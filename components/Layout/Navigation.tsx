          ...
          >
            ...
            <div className="space-x-6">
              <Link href="/cart" aria-label="go to cart">
                <a className="relative text-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800">
                  <ShoppingBagIcon className="w-6 h-6 object-contain border-none text-gray-600 outline-none " />
                  <span className="absolute w-4 h-4 top-0 -right-1 rounded-full bg-gray-900 text-white font-semibold font-sans text-xs flex flex-col items-center justify-center">
                    {cart?.length}
                  </span>
                </a>
              </Link>
